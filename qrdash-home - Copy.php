...
<head>
	...
	<script type="text/javascript" src="https://maps.googleapis.com/maps/api/js?key=AIzaSyApYgH7Jl-sSbuSFpl7SSkRZXKW32UFZms&libraries=geometry"></script>
...
<body class="d-flex flex-column h-100" onload="init();">
							...
							<div class="row">
								...
								<div id="behaviour" class="col-md">
									<select class="form-control" name="behavid" id="behavid" onchange="getbehav(this.value)">
                                        ...
                                        <option value="1"<?php if ($_REQUEST['behavid'] == 1) {
																echo ' selected="selected"';
															} ?> >Social</option>
	...
	?>
	<?php include("includes/techical_level_project.php"); ?>
