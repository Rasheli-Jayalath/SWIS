...
<div id="divfilteration">
    ...
    <div class="holder">
		...
		<table id="tblList" width="99%" border="0" cellspacing="0" cellpadding="0">
        <tr>
		...
		<td align="center">
			 ...
			 <td align="center">
				...
				<a href="./?p=user_mgmt&mode=Suspend&user_cd=<?php echo $rows['user_cd'];?>" onClick="return doConfirm('Are you sure you want to suspend the user?');" title="Suspend Customer's Account">
					...
					<td align="center">
				<a class="lnk" href="./?p=user_mgmt&amp;mode=Delete&amp;user_cd=<?php echo $rows['user_cd'];?>" onclick="return doConfirm('Are you sure you want to Delete Permanently this user ?');" title="Delete Customer"><img src="<?php echo IMAGES_URL;?>icondelete.png" border="0" /></a>
				</td>
				</tr>
			<?php
