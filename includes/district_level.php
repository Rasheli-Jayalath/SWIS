        ...
        <section class="mb-4">
            <div class="container-fluid" style="padding-top: 0px !important;">
                ...
                <div class="tabContent" id="demo">
						...
						$SQL = "Select sum(tot_m) as admales, sum(tot_f) as adfemales, sum(m_06) as chmales, sum(f_06) as chfemales from p2004vp where dcode=$dcode";
                ...
                <div class="tabContent" id="edu">
						...
						$SQL = "Select sum(m_lit) as litmales, sum(f_lit) as litfemales, sum(m_ill) as illmales, sum(f_ill) as illfemales from p2004vp where dcode=$dcode";
                ...
                <div class="tabContent" id="wforce">
						...
						$SQL = "Select sum(mainwork_m) as mainwork_m, sum(mainwork_f) as mainwork_f, sum(main_cl_m) as main_cl_m, sum(main_cl_f) as main_cl_f,sum(main_al_m) as main_al_m, sum(main_al_f) as main_al_f, sum(main_hh_m) as main_hh_m, sum(main_hh_f) as main_hh_f, sum(main_ot_m) as main_ot_m, sum(main_ot_f) as main_ot_f, sum(margwork_m) as margwork_m, sum(margwork_f) as margwork_f from p2004vp where dcode=$dcode";
