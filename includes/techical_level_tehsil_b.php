...
<script type="text/javascript">
	...
	$(document).ready(function() {
		...
		div.innerHTML = '<input type="checkbox" id="villagetoggle" checked="checked" /><label for="villagetoggle">&nbsp;&nbsp;Villages: <img src="<?php echo $_CONFIG['site_url']; ?>kml/Village_dist.png" alt=" Villages" /></label>';
