  ...
  if (!parserOptions.suppressInfoWindows) {
    ...
    google.maps.event.addListener(p, 'click', function(e) {
      ...
      p.infoWindow.open(this.map);
	   var GIS_code=placemark.description; 
	  $(function () {
    var rawString = GIS_code;
    var cleanString = $(rawString).find("td").last().text(); // ... or .text()
var dcode=cleanString.substring(0,2);
var tcode=cleanString.substring(2,4);
var vcode=cleanString.substring(4,15);

	 var giscode='https://india-sdms.smecnet.com/SWIS/qrdash-home.php?map_id=3&componentid=' + dcode + '&subcomponentid=' + tcode +'&activityid='+ vcode +'&behavid=3';
	 //alert(giscode);
	//window.location.href =giscode;
	  });
    });
  }
