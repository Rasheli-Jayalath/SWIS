...
<div id="wrapperPRight">
		<div id="pageContentName" class="shadowWhite"><?php echo UPLOAD_IMAGES_BRD;?></div>
	...
	<?php echo $objCommon->displayMessage();?>
		...
		<div id="tableContainer">
			...
			<div class="clear"></div>			
	  	    <form action="" method="post" name="boqlevel" id="boqlevel" enctype="multipart/form-data" onsubmit="return frmValidate1(this);">
...
?>
              <option value="<?php echo $adata['code']; ?>" <?php if ($activityid == $adata['code']) {echo ' selected="selected"';} ?>><?php echo $adata['code']." - ".$adata['village']; ?></option>
              <?php
}
?>
            </select>
...
?>
		 ...
		 <tr>
                        <td >photolink1</td>
                        <td><input type="file" name="flink1" /></td>
                      </tr>
					  <td >photolink2</td>
                        <td><input type="file" name="flink2" /></td>
                      </tr>
					  <td>photolink3</td>
                        <td><input type="file" name="flink3" /></td>
                      </tr>
					  <td>photolink4</td>
                        <td><input type="file" name="flink4" /></td>
                      </tr>
