...
<div class="wrapper">
   ...
   <header class="main-header" style="color:white; font-size:24px" >
    ...
    <!-- Logo -->
     <a href="/" class="logo" style="padding:0 0 0 0 !important; color:white; font-size:13px" >
          <strong>Water Quality Management System</strong>
   ...
   <div class="btn-group"> 
    ...
    <section class="content content-without-top-padding">
                    <div class="row">
                        ...
                        <img src="wqdashboard.png" style="width:1270px; height:800px" > 
